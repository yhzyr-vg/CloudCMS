 ...
 * <li>{@link cn.trinea.android.common.util.PackageUtils#getInstallLocation()} get system install location</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isTopActivity(android.content.Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#startInstalledAppDetails(android.content.Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 *
